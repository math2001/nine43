...
class Font:
    ...
    def render_raw(self,
        ...
        rotation: int=0,
        size: int=0,
        invert: bool=False) -> Tuple[bytes, Tuple[int, int]]: ...
    ...
    def get_metrics(self, text: str, size: int=0) -> List[Tuple[int, int, int, int, float, float]]:
        ...

    def get_rect(self, text: str, style: int=STYLE_DEFAULT, rotation: int=0, size: int=0) -> Rect:
        ...
