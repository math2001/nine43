...
class Surface(object):
    ...
    def fill(
        self, color: ValidColor, rect: Optional[Rect] = ..., special_flags: int = ...
    ) -> Rect: ...
    def scroll(self, dx: int = ..., dy: int = ...) -> None: ...
    @overload
    def set_colorkey(self, color: ValidColor, flags: int = ...) -> None: ...
    @overload
    ...
    def set_at(self, x_y: Sequence[int], color: ValidColor) -> None: ...
